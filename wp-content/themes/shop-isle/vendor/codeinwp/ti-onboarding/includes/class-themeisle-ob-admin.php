...
class Themeisle_OB_Admin {
	...
	public function add_demo_import_tab( $config ) {
		$config['custom_tabs']['sites_library'] = array(
			'title'           => __( 'Sites Library', 'shop-isle' ),
	...
	private function get_import_steps() {
		return array(
			'plugins'    => array(
				'nicename' => __( 'Installing Plugins', 'shop-isle' ),
				'done'     => 'no',
			),
			'content'    => array(
				'nicename' => __( 'Importing Content', 'shop-isle' ),
				'done'     => 'no',
			),
			'theme_mods' => array(
				'nicename' => __( 'Setting Up Customizer', 'shop-isle' ),
				'done'     => 'no',
			),
			'widgets'    => array(
				'nicename' => __( 'Importing Widgets', 'shop-isle' ),
				'done'     => 'no',
			),
		);
	}
	...
	private function get_strings() {
		return array(
			'preview_btn'                 => __( 'Preview', 'shop-isle' ),
			'import_btn'                  => __( 'Import', 'shop-isle' ),
			'pro_btn'                     => __( 'Get the PRO version!', 'shop-isle' ),
			'importing'                   => __( 'Importing', 'shop-isle' ),
			'cancel_btn'                  => __( 'Cancel', 'shop-isle' ),
			'loading'                     => __( 'Loading', 'shop-isle' ),
			'go_to_site'                  => __( 'View Website', 'shop-isle' ),
			'edit_template'               => __( 'Add your own content', 'shop-isle' ),
			'back'                        => __( 'Back to Sites Library', 'shop-isle' ),
			'note'                        => __( 'Note', 'shop-isle' ),
			'advanced_options'            => __( 'Advanced Options', 'shop-isle' ),
			'plugins'                     => __( 'Plugins', 'shop-isle' ),
			'general'                     => __( 'General', 'shop-isle' ),
			'later'                       => __( 'Keep current layout', 'shop-isle' ),
			'search'                      => __( 'Search', 'shop-isle' ),
			'content'                     => __( 'Content', 'shop-isle' ),
			'customizer'                  => __( 'Customizer', 'shop-isle' ),
			'widgets'                     => __( 'Widgets', 'shop-isle' ),
			'backup_disclaimer'           => __( 'We recommend you backup your website content before attempting a full site import.', 'shop-isle' ),
			'placeholders_disclaimer'     => __( 'Due to copyright issues, some of the demo images will not be imported and will be replaced by placeholder images.', 'shop-isle' ),
			'placeholders_disclaimer_new' => __( 'Some of the demo images will not be imported and will be replaced by placeholder images.', 'shop-isle' ),
			'unsplash_gallery_link'       => __( 'Here is our own collection of related images you can use for your site.', 'shop-isle' ),
			'import_done'                 => __( 'Content was successfully imported. Enjoy your new site!', 'shop-isle' ),
			'pro_demo'                    => __( 'Available in the PRO version', 'shop-isle' ),
			'copy_error_code'             => __( 'Copy error code', 'shop-isle' ),
			'download_error_log'          => __( 'Download error log', 'shop-isle' ),
			'external_plugins_notice'     => __( 'To import this demo you have to install the following plugins:', 'shop-isle' ),
			'error_report'                => sprintf(
				__( 'Hi! It seems there is a configuration issue with your server that\'s causing the import to fail. Please %1$s with us with the error code below, so we can help you fix this.', 'shop-isle' ),
				sprintf( '<a href="https://themeisle.com/contact">%1$s <i class="dashicons dashicons-external"></i></a>', __( 'get in touch', 'shop-isle' ) )
			),
		);
	}
