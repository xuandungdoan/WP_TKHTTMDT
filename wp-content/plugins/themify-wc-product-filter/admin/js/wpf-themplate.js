...
(function ($, window, document, undefined) {
    ...
    WPF = {
        ...
        multiLanguages:function(){
            $('.wpf_language_tabs li a').click(function(e){
                e.preventDefault();
                var $this = $(this),
                    $parent = $this.parent();
                if($parent.hasClass('wpf_active_tab_lng')){
                    return;
                }
                $parent.siblings('.wpf_active_tab_lng').removeClass('wpf_active_tab_lng');
                $parent.addClass('wpf_active_tab_lng');
                var tabs =  $this.parents('.wpf_language_tabs').parent().find('.wpf_language_fields');
               tabs.find('li').removeClass('wpf_active_lng');
               tabs.find('li[data-lng="'+$this.attr('class')+'"]').addClass('wpf_active_lng');
            });
